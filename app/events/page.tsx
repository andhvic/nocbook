...
export default function EventsPage() {
    ...
    useEffect(() => {
        filterEvents()
    }, [events, searchTerm, selectedType, selectedYear, showFeaturedOnly])
    ...
    const hasActiveFilters = searchTerm || selectedType || selectedYear || showFeaturedOnly
    const activeFilterCount = [searchTerm, selectedType, selectedYear, showFeaturedOnly].filter(Boolean).length
