...
export function Button({
    ...
    const variants = {
        ...
        outline: 'border-2 border-primary dark:border-primary-dark text-primary dark:text-primary-dark hover:bg-primary dark:hover:bg-primary-dark dark:hover:text-white',
